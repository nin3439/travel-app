...
const Countries: any = [
  {
    ...
    localizations: [
      ...
      },
      {
        ...
        capital: 'Рым',
        description:
          "Італія (іт. Italia [itaːlja]), афіцыйная назва - Італьянская Рэспубліка (іт. Repubblica Italiana [repubːlika italjaːna]) - дзяржава ў Паўднёвай Еўропе, у цэнтры Міжземнамор'я. Уваходзіць у Еўрасаюз і НАТА з моманту іх стварэння, з'яўляецца трэцяй па велічыні эканомікай еўразоны. Мяжуе з Францыяй на паўночным захадзе (працягласць мяжы - 488 км), Швейцарыяй (740 км) і Аўстрыяй (430 км) - на поўначы, Славеніяй - на паўночным усходзе (232 км). Ўнутры тэрыторыі Італіі знаходзяцца дзве дзяржавы-анклава: дзяржава Сан-Марына і размешчана ўнутры тэрыторыі Рыма асацыяванае з Італіяй дзяржава Ватыкан, з кожным з якіх Італія мае ўнутраную мяжу працягласцю адпаведна 39 км і 3,2 км. Займае Апенінскі паўвостраў, крайні паўночны захад Балканскага паўвострава, Паданская раўніну, паўднёвыя схілы Альп, выспы Сіцылія, Сардзінія і шэраг дробных астравоў. На тэрыторыі Італіі знаходзіцца 55 помнікаў Сусветнай спадчыны ЮНЕСКА - Італія падзяляе з Кітаем першае месца па іх колькасці.",
        name: 'Італія',
      },
    ],
  ...
  },
  {
    ...
    localizations: [
      ...
      },
      {
        ...
        capital: 'Токiо',
        description:
          'Японія (яп. 日本, Nippon) - астраўная дзяржава ва Усходняй Азіі, размешчанае ў паўночна-заходняй частцы Ціхага акіяна. На захадзе ён абмываецца Японскім морам і распасціраецца ад Ахоцкага мора на поўначы да Усходне-Кітайскага мора і Тайваня на поўдні. Японія - адзінаццатая па колькасці насельніцтва краіна ў свеце, а таксама адна з самых густанаселеных і урбанізаваных. Каля трох чвэрцяў тэрыторыі краіны занята гарамі, а насельніцтва ў 125,62 мільёна чалавек засяроджана на вузкіх прыбярэжных раўнінах. Японія падзелена на 47 адміністрацыйных прэфектур і восем традыцыйных рэгіёнаў. Раён Вялікага Токіо - самы густанаселены мегаполіс ў свеце з насельніцтвам больш 37,4 мільёна чалавек.',
        name: 'Японія',
      },
    ],
